...
import{
    ...
    // 引入 ECharts 主模块
    // var echarts = new URL('echarts/lib/echarts',import.meta.url);
    // 引入柱状图
    // new URL('echarts/lib/chart/graph',import.meta.url);
    // // 引入提示框和标题组件
    // new URL('echarts/lib/component/tooltip',import.meta.url);
    // new URL('echarts/lib/component/title',import.meta.url);
        ...
        methods:{
            ...
            initCharts(){
                if(!this.myChart){
                    ...
                    this.myChart.on('dblclick',(params)=>{//双击进入
                        this.$router.push({
                    ...
                    series: [
                        {
                            ...
                            itemStyle:{
                                normal: {
                                    color:'rgb(24, 201, 25)',
                                    cursor:'pointer',
                                    // color:Math.floor(Math.random()*16777215).toString(10),
